import { Wrench, Clock, CheckCircle, XCircle, FileText, Upload } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-yellow-600">
                {mockWorks.filter((w) => w.status === 'Pendiente de Visita').length}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-blue-600">
                {mockWorks.filter((w) => w.status === 'En Ejecución').length}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-600">
                {mockWorks.filter((w) => w.status === 'Terminada').length}
              </p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-600">
                {mockWorks.filter((w) => w.status === 'No Aplica').length}
              </p>
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4" onClick={() => setSelectedWork(null)}>
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Documento (si terminada) */}
              {selectedWork.status === 'Terminada' && (
                <div>
                  ...
                  {selectedWork.document ? (
                    ...
                    <div className="p-4 border-2 border-dashed border-gray-300 rounded-lg text-center">
                      ...
                      <p className="text-sm text-gray-600 mb-2">Subir documento certificado</p>
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-200">
                ...
                {selectedWork.status !== 'Terminada' && (
                  <button className="flex-1 px-4 py-2 bg-[#2B5F7F] text-white rounded-lg hover:bg-[#1a4968] transition-colors">
                    Actualizar Estado
                  </button>
                )}
              </div>
